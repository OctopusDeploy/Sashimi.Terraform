...
wait_file "/publish/Calamari.Terraform.Tests/Calamari.Terraform.Tests.dll" 60 || {
  echo "/publish/Calamari.Terraform.Tests/Calamari.Terraform.Tests.dll not found"
  exit 1
}
...
cp -a /publish/Calamari.Terraform.Tests/. /Octopus/Calamari.Terraform.Tests
