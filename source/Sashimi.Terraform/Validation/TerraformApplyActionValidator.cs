...
{
    class TerraformApplyActionValidator : TerraformDeploymentActionValidator
    {
        public TerraformApplyActionValidator(ICloudTemplateHandlerFactory cloudTemplateHandlerFactory)
