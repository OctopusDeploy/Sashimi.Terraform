...
{
    abstract class TerraformDeploymentActionValidator : AbstractValidator<DeploymentActionValidationContext>
    {
        const string DefaultTemplate = "{}";
        readonly ICloudTemplateHandlerFactory cloudTemplateHandlerFactory;

        protected TerraformDeploymentActionValidator(ICloudTemplateHandlerFactory cloudTemplateHandlerFactory)
        {
        ...
        protected IEnumerable<string> ValidationVariables(IReadOnlyDictionary<string, string> properties)
        {
        ...
        protected static bool IsTemplateFromPackage(IReadOnlyDictionary<string, string> properties)
        {
        ...
        static bool AzureAccountSelected(DeploymentActionValidationContext a)
        {
        ...
        static bool AwsAccountSelected(DeploymentActionValidationContext a)
        {
        ...
        static bool ChosenToAssumeRole(DeploymentActionValidationContext a)
        {
        ...
        static bool ChosenToUseInstanceRole(DeploymentActionValidationContext a)
        {
